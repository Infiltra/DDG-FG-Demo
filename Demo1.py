...
class Demo1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "SimpleTxRX")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("SimpleTxRX")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Demo1")
        ...
        self.rtlsdr_source_0.set_sample_rate(1.8e6)
        self.rtlsdr_source_0.set_center_freq(500e6, 0)
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.iio_pluto_sink_0 = iio.pluto_sink('ip:192.168.2.1', 500000000, int(1.8e6), 1000000, 32768, False, 5.0, '', True)
        ...
        for _label in self._delay_labels: self._delay_combo_box.addItem(_label)
        ...
        self.connect((self.correctiq_correctiq_0, 0), (self.digital_pfb_clock_sync_xxx_0, 0))
        ...
        self.connect((self.rtlsdr_source_0, 0), (self.correctiq_correctiq_0, 0))
...
def main(top_block_cls=Demo1, options=None):
